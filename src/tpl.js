export function getIssueTpl(opens = 0, closed = 0) {
  return `
    ...
    <div id="issues-wrapper" class="m-auto  base-outer mt-6 bg-slate-100">
      <div class="issue-header h-16 flex justify-between items-center border-b">
        ...
        <div class="statusTab flex">
          <div class="whitespace-nowrap open-count font-bold cursor-pointer" open-btn>${opens} Opens</div>
          <div class="whitespace-nowrap close-count ml-3 cursor-pointer">${closed} Closed</div>
        </div>
