...
import {fetchData, createRenderer, createEventBinder, asyncPipe, getClassList} from "./utils.js";
...
(
  () => {
    ...
    const init = async () => {
      ...
      // load data
      data.issues = await fetchData("data-sources/issues.json");
      data.labels = await fetchData("data-sources/labels.json");
    };
