    ...
    <div id="issues-wrapper" class="m-auto  base-outer mt-6 bg-slate-100">
      <div class="issue-header h-16 flex justify-between items-center border-b">
        ...
        <div class="statusTab flex">
          <div class="whitespace-nowrap open-count font-bold cursor-pointer"><span class='open-count-value'>0</span> Opens</div>
          <div class="whitespace-nowrap close-count ml-3 cursor-pointer"><span class='close-count-value'>0</span> Closed</div>
        </div>
...
export function getLabelTpl() {
  ...
  <form id="new-label-form" class="hidden p-3 mb-3 mt-6 border rounded-sm font-bold" action="/labels" accept-charset="UTF-8" method="post">
    ...
    <div id="label-input-wrapper" class="flex justify-between items-start mb-2">
      ...
      <dl class="form-group my-2">
        ...
        <dd class="mt-2 flex">
          ...
          <div class="ml-2">
            <input type="text" id="label-color-input" name="label-color[description]"
            class="w-full p-2 base-outer focus:outline-none"
            placeholder="#color" disabled value="" maxlength="100">
          </div>
      ...
      <div
        ...
        <button id="label-create-button" type="submit" class="base-outer p-2 mr-4 bg-green-700 text-white disabled=""> Create label
        </button>
      </div>
  ...
  <div id="labels-wrapper" class="m-auto  base-outer mt-6 bg-slate-100">
    <div class="label-header h-16 flex justify-between items-center border-b">
      ...
      <div class="mr-3 d-none pl-4">
        <div class="open-count whitespace-nowrap font-bold cursor-pointer">6 Labels</div>
      </div>
    ...
    <button class="refresh-labels-button base-outer p-2 mt-2 float-right">update labels</button>
    </div>
  `;
}
