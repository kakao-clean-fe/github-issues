export function getIssueHeaderTpl() {
  return `
      ...
      <div class="filter-menu w-2/3 px-3 py-1 flex base-outer items-center">
        <div class="filter p-3">Filters</div>
          <form action="/" class="p-3 w-full">
            <input type="text" class="w-full bg-slate-100 focus:outline-none" name="filter-text" id="filter-input" placeholder="keyword...">
          </form>
        </div>
...
export function getIssueListHeaderTpl() {
  return `
  <div class="issue-header h-16 flex justify-between items-center border-b">
    ...
    <div class="statusTab flex">
      <div class="whitespace-nowrap open-count cursor-pointer">3 Opens</div>
      <div class="whitespace-nowrap close-count ml-3 cursor-pointer">1 Closed</div>
    </div>
...
export function getIssueListTpl(items) {
  return `
...
export function getLabelHeaderTpl() {
  return `
    <div id="header" class="flex justify-between">
...
export function getLabelCreateTpl(hidden) {
  return `
...
export function getLabelListTpl(labelCnt, labels) {
  return `
...
export function getLabelContainerTpl() {
  return `
